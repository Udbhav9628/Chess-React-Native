...
const Home = ({ navigation }: propsTypes) => {
	...
	useEffect(() => {
		if (contextApi?.opponentSocketId?.length) {
			navigation.navigate('FriendPlay');
		}
	}, [contextApi?.opponentSocketId]);
	...
	return (
		<View style={styles.container}>
			...
			<LinearGradient
				...
				colors={['#030761', '#fc03a9']}
				style={styles.box}
			>
				<TouchableOpacity
					onPress={contextApi?.handleRandomConnection}
